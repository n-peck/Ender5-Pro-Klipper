...
- [x] Raspberry Pi configured
- [x] Klipper installed
- [x] Mainsail installed
- [x] Git repository established
- [x] SSH Git workflow configured
- [x] SKR Mini E3 V3 configured
- [x] X/Y/Z movement verified
- [x] Motor directions verified
- [x] Endstops verified
